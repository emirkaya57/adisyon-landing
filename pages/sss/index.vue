...
<div class="card-header" role="tab" id="headingFour">
  <h5 class="h5-sm">
      <a class="collapsed" data-toggle="collapse" :href="'#collapseFour' + soru.id" role="button" aria-expanded="false" aria-controls="collapseFour">   		
          {{soru.content}}
      </a>
    </h5>
</div>
          ...
          <div class="col-md-12">
            <nav aria-label="Page navigation">
              <ul class="pagination ico-20 justify-content-center">
                ...
                <li
                  class="page-item"
                  :class="params.page == pagesData.pages ? 'disabled' : ''"
                >
