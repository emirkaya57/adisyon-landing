                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-7 col-lg-6">
                        <div class="hero-3-txt pc-10 mb-40 wow fadeInRight" data-wow-delay="0.4s">
                            ...
                            <!-- Title -->
                            <h2 class="h2-lg ">Müşteri/Tedarikçi Yönetimi</h2>

                            <!-- Text -->
                            <p class="p-xl grey-color">İşletmenizi ve Müşterilerinizi kolaylıkla yönetmek istiyorsanız bu
                                çözüm tam size göre.
                            </p>
                    ...
                    <div class="col-md-5 col-lg-6">
                        <div class="hero-3-img text-center mb-40 wow fadeInLeft" data-wow-delay="0.6s">
                            <img class="img-fluid" src="/anasayfa/3.png" alt="hero-image">
                        </div>
                    </div>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-7 col-lg-6">
                            <div class="txt-block left-column mb-40 wow fadeInLeft" data-wow-delay="0.6s">
                                <!-- Section ID -->
                                <span class="section-id grey-color">Müşteri Karmaşıklığına Çözüm</span>
                                ...
                                <!-- Text -->
                                <p class="p-lg">
                                    MasaHesap ile müşteri yönetimi oldukça kolaydır. İşletmenize gelen müşterileri kolayca
                                    kayıt edebilir, onlara bakiye tanımlayabilirsiniz.Böylelikle müşteri karmaşıklığının
                                    önüne geçmiş olursunuz.Tedarikçilerinizi kayıt edebilir ve kontrol edebilirsiniz.
                                </p>
                            </div>
                        </div>
                        <!-- END CONTENT TXT -->
