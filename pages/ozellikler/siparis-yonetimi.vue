                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-7 col-lg-6">
                        <div class="hero-3-txt pc-10 mb-40 wow fadeInRight" data-wow-delay="0.4s">
                            ...
                            <!-- Title -->
                            <h2 class="h2-lg ">Kolay Sipariş Takibi</h2>

                            <!-- Text -->
                            <p class="p-xl grey-color">Bütün Siparişlerinizin Özeti MASAHESAP'ta
                            </p>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-7 col-lg-6">
                            <div class="txt-block left-column mb-40 wow fadeInLeft" data-wow-delay="0.6s">
                                ...
                                <!-- Text -->
                                <p class="p-lg">
                                    MASAHESAP ile siparişlerinizi kağıda ihtiyaç duymadan kontrol edebilirsiniz.
                                    İşletmenizin siparişlerini tek bir yere topladık. Bütün
                                    siparişlerinizi bütün cihazlardan tek panelde görüntüleyebilirsiniz. Hızlı ve kolay
                                    sipariş yönetimiyle personelleriniz ve müşterileriniz artık daha mutlu olacak.
