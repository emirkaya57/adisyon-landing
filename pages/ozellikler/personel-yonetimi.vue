                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-7 col-lg-6">
                        <div class="hero-3-txt pc-10 mb-40 wow fadeInRight" data-wow-delay="0.4s">
                            ...
                            <!-- Title -->
                            <h2 class="h2-lg ">Personel Yönetimi</h2>

                            <!-- Text -->
                            <p class="p-xl grey-color">Personellerinizi kolaylıkla yönetmek istiyorsanız bu
                                çözüm tam size göre.
                            </p>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-7 col-lg-6">
                            <div class="txt-block left-column mb-40 wow fadeInLeft" data-wow-delay="0.6s">
                                <!-- Section ID -->
                                <span class="section-id grey-color">Personel Karmaşıklığına Çözüm</span>
