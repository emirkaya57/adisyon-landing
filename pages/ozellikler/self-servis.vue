                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-7 col-lg-6">
                        <div class="hero-3-txt pc-10 mb-40 wow fadeInRight" data-wow-delay="0.4s">
                            ...
                            <!-- Title -->
                            <h2 class="h2-lg ">Kolay Self - Servis Takibi</h2>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-7 col-lg-6">
                            <div class="txt-block left-column mb-40 wow fadeInLeft" data-wow-delay="0.6s">
                                <!-- Section ID -->
                                <span class="section-id grey-color">Self - Servis</span>
                                ...
                                <!-- Text -->
                                <p class="p-lg">
                                    İşletmenizdeki Self - Servis siparişleri bazen karmaşık hale gelebilir, bu
                                    karmaşıklığın
                                    çözümü MASAHESAP'ta gün sonundaki self - servis siparişlerini tek panelden kolayca takip
                                    edebilirsiniz.
                                </p>
                            </div>
                        </div>
