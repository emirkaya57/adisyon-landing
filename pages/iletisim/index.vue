            ...
            <div class="form-holder">
              <form id="contactForm" name="contact-form" class="row contact-form" method="post">
                ...
                <div id="input-message" class="col-md-12 input-message">
                  ...
                  <textarea required class="form-control message" name="message" rows="6" v-model="description"
                    placeholder="Sorununuzu Detaylı Yazınız" minlength="5" autocomplete="off"></textarea>
                </div>
                <!-- Contact Form Button -->
                <div class="col-md-12 mt-15 form-btn text-right">

                  <button type="button" @click="getData" id="click" class="btn btn-skyblue tra-skyblue-hover">
                    Gönder
                  </button>
                </div>
              </form>
