$(function () {
  $.smartbanner({
    title: "İş Hesap", // What the title of the app should be in the banner (defaults to <title>)
    author: "Kuvarssoft", // What the author of the app should be in the banner (defaults to <meta name="author"> or hostname)
